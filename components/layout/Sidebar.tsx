...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: "LearnPath", icon: GraduationCap, path: "/learnpath" },
    { name: "Advisor", icon: BrainCircuit, path: "/advisor" },
    { name: "Community", icon: Users, path: "/community" },
    { name: "Market Pulse", icon: TrendingUp, path: "/market-pulse" },
  ];
    ...
    <aside className="w-64 h-screen bg-white border-r border-gray-100 flex flex-col justify-between fixed left-0 top-0">
      <div>
        ...
        <div className="p-6">
          ...
          <p className="text-xs text-gray-400 mt-1 uppercase tracking-wider">Blueprint Ledger</p>
        </div>
