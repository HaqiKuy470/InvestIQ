...
import ShakaBot from "@/components/dashboard/ShakaBot";
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <h1 className="text-5xl font-black text-slate-900 tracking-tight leading-tight">
            Selamat datang kembali,<br />Komandan.
          </h1>
        </div>
        <div className="flex items-center gap-2 bg-white border border-slate-100 p-1.5 pr-4 rounded-full shadow-sm w-fit">
          ...
          <span className="text-sm font-bold text-slate-700">Pertumbuhan Agresif</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm relative overflow-hidden group">
          <div className="flex justify-between items-start relative z-10">
            <div className="max-w-xs">
              <h2 className="text-2xl font-bold text-slate-900">Kemajuan Alur Belajar</h2>
              <p className="text-sm text-slate-500 mt-2 leading-relaxed">
                Menguasai Dividen Hasil Tinggi: Modul 4 dari 12 sedang berlangsung.
              </p>
            </div>
          ...
          <div className="mt-12 relative z-10">
            <div className="flex justify-between items-end mb-3">
              ...
              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">Arsitek Level 3</span>
            </div>
        ...
        <div className="bg-blue-600 rounded-[32px] p-8 text-white shadow-xl shadow-blue-600/20 flex flex-col justify-between relative overflow-hidden">
          ...
          <div>
            <p className="text-blue-100 font-medium text-sm">Nilai Portofolio</p>
            <h2 className="text-4xl font-black mt-1 tracking-tight">Rp 15.453.000</h2>
            <div className="inline-flex items-center gap-1.5 bg-white/10 px-3 py-1 rounded-full text-xs font-bold mt-4 backdrop-blur-md">
              <ArrowUpRight className="w-3 h-3" /> +12,4% bulan ini
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 flex flex-wrap items-center gap-8 shadow-sm">
            <span className="text-xs font-black text-slate-400 uppercase tracking-widest border-r pr-8">Penggerak Teratas</span>
            {topMovers.map((stock) => (
