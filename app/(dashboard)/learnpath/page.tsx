...
const modules = [
  ...
  {
    id: 3,
    level: "Level 2: Pendapatan Tetap",
    title: "Obligasi",
  ...
  {
    id: 4,
    level: "Level 2: Pengideksan Lanjutan",
    title: "ETF",
    ...
    <div className="max-w-5xl mx-auto space-y-10 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-6">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl font-black text-slate-900 mt-4 leading-tight">
            Kuasai Seni <span className="text-blue-600">Membangun Kekayaan</span>
          </h1>
          <p className="text-slate-500 mt-3 text-sm leading-relaxed">
            Belajar dasar-dasar investasi hingga lanjutan 
          </p>
        </div>

        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm w-full md:w-64">
          <div className="flex justify-between items-center mb-3">
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Kemajuan Keseluruhan</span>
          ...
          <div className="flex items-start gap-2">
            ...
            <p className="text-[10px] text-slate-500 leading-tight">AI memperkirakan 4 modul lagi menuju Level 2</p>
          </div>
        </div>
      </div>
            ...
            <div className="flex-1 p-8 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2 text-slate-400">
                  ...
                  <span className="text-xs font-bold">{mod.lessons} Pelajaran</span>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-50 p-6 rounded-[32px] border border-slate-100 flex flex-col justify-between h-40">
           <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Target Mingguan</span>
           <div>
              <div className="text-2xl font-black text-slate-900 mb-1">3/5 Modul</div>
        ...
        <div className="bg-slate-50 p-6 rounded-[32px] border border-slate-100 flex flex-col justify-between h-40">
           <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Poin Keahlian</span>
           <div>
              <div className="text-2xl font-black text-slate-900 mb-1">1,240 XP</div>
              <p className="text-[10px] font-bold text-blue-600 uppercase">Top 15% bulan ini</p>
           </div>
        </div>
        ...
        <div className="bg-blue-600 p-6 rounded-[32px] text-white flex flex-col justify-between h-40 shadow-lg shadow-blue-600/20 group cursor-pointer hover:bg-blue-700 transition-colors">
           <p className="text-sm font-medium text-blue-100">Merasa percaya diri?</p>
           <div className="flex justify-between items-end">
              <h3 className="text-xl font-bold">Ikuti Kuis</h3>
