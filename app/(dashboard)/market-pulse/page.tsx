...
export default function MarketPulsePage() {
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-black text-slate-900">Market Pulse</h1>
        <p className="text-slate-500 mt-2">Daily market insights powered by AI</p>
      </div>

      {/* Sentiment Report Banner */}
      <div className="bg-emerald-50/50 border border-emerald-100 rounded-[32px] p-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-[0.2em]">Sentiment Report</p>
            <h3 className="text-xl font-bold text-emerald-900">Market Sentiment Today: <span className="text-emerald-500">Bullish</span></h3>
          </div>
        </div>
      ...
      {/* Full Width Chart ( reusing the previous component ) */}
      <div className="pt-4">
        <MarketPulseChart />
      </div>
    </div>
