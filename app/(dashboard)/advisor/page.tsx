  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-4">
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          <p className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-1">Kuesioner</p>
          <h1 className="text-3xl font-black text-slate-900">Penemuan Profil Risiko</h1>
        </div>
      ...
      <div className="space-y-12">
        ...
        <div className="bg-slate-50 rounded-[32px] p-10 flex flex-col md:flex-row items-center gap-10 border border-slate-100">
          ...
          <div className="space-y-4">
            <h4 className="text-xl font-bold text-slate-900">Mengapa ini penting?</h4>
            <p className="text-slate-600 leading-relaxed max-w-lg">
              Jangka waktu adalah variabel paling kritis dalam menentukan alokasi aset Anda.
              Jangka waktu yang lebih panjang memungkinkan Anda menghadapi volatilitas pasar untuk imbal hasil historis yang lebih tinggi.
            </p>
            <div className="flex gap-4 pt-2">
              <span className="text-xs font-bold text-blue-600 flex items-center gap-1">
                <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div> Alokasi Cerdas
              </span>
              <span className="text-xs font-bold text-blue-600 flex items-center gap-1">
                <div className="w-1.5 h-1.5 bg-blue-600 rounded-full"></div> Berdasarkan Data
              </span>
            </div>
          </div>
        </div>
